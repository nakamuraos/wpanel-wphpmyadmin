    ...
    if (IS_LOGIN) {
        ...
        if ($dir == null || !is_dir(processDirectory($dir))) {
            ...
            if (isset($_POST['submit'])) {
                ...
                } else if (intval($_POST['type']) === 0 && is_dir($dir . '/' . $_POST['name'])) {
                    echo 'Tên thư mục đã tồn tại';
                } else if (intval($_POST['type']) === 1 && is_file($dir . '/' . $_POST['name'])) {
            ...
            echo '<div class="list">
                <form action="create.php?dir=' . $dirEncode . $pages['paramater_1'] . '" method="post">
                    ...
                    <input type="text" name="name" value="" size="18"/><br/>
