...
define('LOGIN_PASSWORD_DEFAULT', md5(md5('123456')));
define('VERSION','1.0');
...
if ($configs['page_list'] > 0 && isset($_GET['page_list'])) {
...
{
$content = "<?php if (!defined('_PHONHO_HPA')) die('Not access'); else \$configs = array(";
...
return @file_put_contents('incfiles/PATH_CONFIG', $content);
}
...
return $out == null ? null : ($isAssoc ? (array)$out : $out);
}
